...
class SaleReportWizard(models.TransientModel):
        ...
        def print_report_xl(self):
            ...
            if len(record_ids)== 0:
                ...
                return self.env.ref('bi_pdf1.report_sale_docs').report_action(self, data=datas)
...
class BiPdfReport(models.AbstractModel):
    ...
    def _get_report_values(self,docids, data):
        ...
        self.env.cr.execute('select am.name as id, pt.name as partner_name, rp.name as name, am.invoice_date, am.invoice_date_due, am.amount_untaxed_signed, am.amount_total_signed, am.amount_residual_signed, am.state, am.invoice_payment_state '\
                                                ...
                                                (str(date_from),str(date_to),'out_invoice'))
